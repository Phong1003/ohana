import api from "../api";
import { URL_GET_ADR, URL_GET_MONEY_CHART, URL_GET_CHART, URL_HISTORY, URL_NEW_PAY_ROOM, URL_UPDATE_PAY_ROOM, URL_GET_PAY_ROOM, URL_NEW_TENANT, URL_DELETE_TENANT, URL_UPDATE_TENANT, URL_GET_TENANT_ROOM, URL_GET_DETAILS, URL_LOGIN, URL_REGISTER, URL_SEARCH, URL_NEW_HOME, URL_CATEGORY, URL_GET_USER, URL_USER, URL_USER_EDIT, URL_EDIT, URL_CREATE_CATEGORY, URL_DELETE, URL_ACTIVE, URL_MONEY, URL_GET_USER_TOKEN } from "../../constants/endpoints";
...
export function getChart() {
  return api.get(URL_GET_CHART)
}

export function getMoneyChart(data) {
  return api.get(URL_GET_MONEY_CHART + `${data}`)
}

export function getAdr() {
  return api.get(URL_GET_ADR)
}